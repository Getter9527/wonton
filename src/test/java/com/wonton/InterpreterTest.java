...
public class InterpreterTest {
    ...
    public void testNullLiteral() {
        // 源代码
        String source = FileUtils.readSource("scripts/assign_null_literal.wonton");
        Logger.debug("源代码:\n{0}", source);
    ...
    public void testWhileStatement() {
        // 源代码
        String source = FileUtils.readSource("scripts/while_statement.wonton");
        Logger.debug("源代码:\n{0}", source);
    ...
    public void testFunction() {
        // 源代码
        String source = FileUtils.readSource("scripts/function.wonton");
        Logger.debug("源代码:\n{0}", source);
